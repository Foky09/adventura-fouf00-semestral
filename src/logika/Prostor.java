...
public class Prostor {
    ...
    public void odeberVychod(Prostor vedlejsi) {
        vychody.remove(vedlejsi);
    }
    ...
    public Vec getVec(String nazevVeci){
        for(Vec neco : veci){
            if(neco.getNazev().equals(nazevVeci)&& neco.isPrenositelnost()){
                return neco;     
            }
    ...
    private String popisVeci() {
        ...
        for (Vec neco : veci) {
            vracenyText += neco.getNazev() + " " + neco.getCena() + "Kč , ";
        }
        return vracenyText;
    }
